...
public class SCCommand implements Command {
    ...
    private final Collection<SCSubcommandData> subcommandData = getSubcommands();

    @Override
    public String getActionID() {
        return Constants.STRATEGY_CARD;
    }
    ...
    public void execute(SlashCommandInteractionEvent event) {
        ...
        SCSubcommandData executedCommand = null;
        for (SCSubcommandData subcommand : subcommandData) {
    ...
    private Collection<SCSubcommandData> getSubcommands() {
        Collection<SCSubcommandData> subcommands = new HashSet<>();
        subcommands.add(new LeadershipPrimary());
